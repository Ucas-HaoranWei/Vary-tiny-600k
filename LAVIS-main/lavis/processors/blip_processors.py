...
class BlipCaptionProcessor(BaseProcessor):
    def __init__(self, prompt="", max_words=2048):
        self.prompt = prompt
    ...
    def from_config(cls, cfg=None):
        ...
        max_words = cfg.get("max_words", 2048)
...
class BlipQuestionProcessor(BaseProcessor):
    def __init__(self, max_words=2048):
        self.max_words = max_words
    ...
    def __init__(
        ...
        self.transform = transforms.Compose(
            [
                ...
                # transforms.RandomHorizontalFlip(),  # do not flip for vary
                RandomAugment(
                    2,
                    5,
                    isPIL=True,
